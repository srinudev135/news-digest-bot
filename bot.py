...
1. Settings persisted to settings.json — survive restarts
1. Single workflow: sends digest at startup + stays alive for interactive chat
1. Default topics: GeoPolitics, Finance, AI Updates, Crypto
   “””
...
# **xai** is a special built-in key — fetched via Apify, not RSS/NewsAPI
“**xai**”: {
...
“active_topics”:  [“geopolitics”, “ai_updates”, “crypto”, “**xai**”],
“news_count”:     5,
}
...
text    = f”{divider}\n🐦 <b>X TRENDS — INDIA</b>\n{divider}\n\n{lines}”
ask_row  = [InlineKeyboardButton(f”💬 {i}”, callback_data=f”ask|**xtrends**|{i-1}”) for i in range(1, len(trends)+1)]
...
ask_row  = [InlineKeyboardButton(f”💬 {i}”, callback_data=f”ask|**xai**|{i-1}”) for i in range(1, len(tweets)+1)]
...
if section_key == “**xtrends**”:
cfg = {“emoji”: “🐦”, “label”: “X Trends”}
elif section_key == “**xai**”:
